...
<html lang="en">
	...
	<body>
		...
		<main>
            ...
            <audio id="audio" src="audio/dice.mp3"></audio>
			<audio id="audiowin" src="audio/win2.mp3"></audio>
			<audio id="audiolose" src="audio/lose1.mp3"></audio>
			<audio id="audioladder" src="audio/ladder.mp3"></audio>
            <audio id="audiosnake" src="audio/snake.mp3"></audio>

			<img id="static_dice" src="images/staticdice.jpg" alt="A dice" onclick="roll();"><br/>
			</div>
			</div>
			</div>
		</main>
