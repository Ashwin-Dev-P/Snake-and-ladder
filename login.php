<?php
    ...
    if( isset($_POST['guestusername']) ){
		error_log("Login success ".$_POST['username']);
		$_SESSION['account_id'] = 12;
		$_SESSION['username'] = htmlentities($_POST['guestusername']);
		$_SESSION['darkmode'] = 0;
		$darkmode = 0;
...
<html>
	<head>
		...
		<meta property="og:title" content="Snake and Ladder">
		<meta property="og:description" content="Online Game">
		<meta property="og:url" content="http://ashwindev14.infinityfreeapp.com/index.php">
	...
	<body>
		<div class="registration-form" id="mainform">
			<form method="post">
				<div id="login">
					<h1>LOGIN</h1>
				</div>
            ...
            <form method="post" id="guestform">
                <input type="text" class="form-control item" id="guestusername" name="guestusername"  value="guest" hidden>
				<div class="form-group" id="guest" >
					<button type="submit" class="btn btn-block create-account">GUEST LOGIN</button>
				</div>
            </form>
