<?php
	...
	if ( ! isset($_SESSION['username']) || strlen($_SESSION['username']) < 1  ) {
		$_SESSION['error'] = "Please log in to continue".$_SESSION['username'];
    ...
    if($_SESSION['account_id'] == '12' ){
		$_SESSION['error'] = "You are not authorised to access the data.";
		header('Location: index.php');
		return;
	}
			...
			<div class="container">
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li class="menu-has-children"><a href=""><?= $_SESSION["username"]?></a>
							<ul>
