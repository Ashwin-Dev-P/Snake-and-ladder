		...
		<div class="registration-form">
			<form method="post">
				...
				<div class="form-group">
					<input type="text" class="form-control item" id="fullname" name="fullname" placeholder="FULL NAME" value="<?php echo $_SESSION["fullname"] ?>" >
				</div>
				<div class="form-group">
					<input type="text" class="form-control item" id="username" name="username" placeholder="USERNAME" value="<?php echo $_SESSION["username"] ?>" >
				</div>
				<div class="form-group">
					<input type="password" class="form-control item" id="password" name="password" placeholder="PASSWORD" value="<?php echo $_SESSION["password"] ?>"  >
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<input type="text" class="form-control item" id="email" name="email" placeholder="EMAIL(OPTIONAL)"  value="<?php echo $_SESSION["email"] ?>">
				</div>
				<div class="form-group">
					<input type="text" class="form-control item" id="number" name="number" placeholder="PHONE NUMBER(OPTIONAL)" value="<?php echo $_SESSION["number"] ?>">
				</div>
